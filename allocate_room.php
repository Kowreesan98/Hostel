		...
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<li class="nav-item">
						<a class="nav-link" href="message_hostel_manager.php">Appels</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="contact_manager.php">Reply for studentss</a>
					</li>
					<li class="dropdown nav-item">
...
<div class="container">
<h2 class="heading text-capitalize mb-sm-5 mb-4"> Allocate Rooms for Student </h2>
<?php
		...
		<div class="footer-grid">
			...
			<div class="list-footer">
				<ul class="footer-nav text-center">
					...
					<li>
						<a href="contact_manager.php">Reply for students</a>
					</li>
					<li>
